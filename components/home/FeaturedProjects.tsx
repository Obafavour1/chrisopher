      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12 sm:mb-16">
          ...
          <p className="text-base sm:text-lg text-gray-600 max-w-2xl mx-auto">
            {showAll 
              ? 'A complete look at my portfolio of process simulation and automation projects' 
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8 mb-12">
          {displayProjects.map((project) => (
            <div 
              key={project.id}
              className="group bg-white rounded-2xl overflow-hidden border border-gray-100 shadow-sm hover:shadow-xl transition-all duration-500 hover:-translate-y-1 flex flex-col h-full"
            >
              {/* Project Image */}
              ...
              <div className="p-6 flex flex-col flex-1">
                ...
                <Link 
                  ...
                  className="mt-auto w-full py-3 bg-[#1a2332] hover:bg-[#243447] text-white font-semibold rounded-lg transition-colors duration-300 flex items-center justify-center gap-2 group/btn"
                >
                  Learn More
