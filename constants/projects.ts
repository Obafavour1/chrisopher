export interface Project {
  ...
  controlAndOperability?: {
    ...
    flowControls: Array<"feed" | "reflux" | "side-draw" | "bottoms">;
...
export const projects: Project[] = [
  {
    ...
    description:
      "Multidisciplinary engineering study of an ethylene cracker module covering layout, piping, materials, electrical, instrumentation, structural design, transport, and foundations.",
    longDescription:
  ...
  },
  {
    ...
    title:
      "Energy Efficiency Improvement of an Aromatics Complex (Pinch Analysis)",
    description:
      "Energy efficiency study of an aromatics complex using Pinch Analysis, HEN redesign, and economic evaluation to reduce fuel consumption and improve EII.",
    longDescription:
  ...
  },
  {
    ...
    description:
      "Design, simulation, and economic optimization of a propylene–propane splitter for an FCC gas plant, focusing on high-purity propylene recovery and minimum energy consumption.",
    longDescription:
    ...
    keyTechnicalDecisions: {
      operatingPressure:
        "Selected from reflux drum dew/bubble point constraints using air condensation",
      optimalConfiguration: {
  ...
  },
  {
    ...
    title:
      "Hydrodesulfurization (HDS) Unit – P&ID & Process Engineering Project",
    description:
      "Engineering design of an industrial gasoil hydrodesulfurization unit, covering process simulation, equipment sizing, control philosophy, and full P&ID development.",
    longDescription:
  ...
  },
  {
    ...
    description:
      "Dynamic modeling and simulation of a binary distillation column using Python, including stage-wise mass balances, VLE relations, and numerical solution of ODE/DAE systems.",
    longDescription:
    ...
    date: "2024",
    technologies: ["Python", "NumPy", "SciPy", "Matplotlib", "Spyder IDE"],
    tags: [
      "Process Simulation",
